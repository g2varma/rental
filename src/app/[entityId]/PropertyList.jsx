...
const PropertyList = async ({ entityId, searchParams }) => {
  const {
    page,
    size,
    type,
  ...
  const totalListings = listingsRes?.totalCount;
  ...
  return (
    ...
    <div>
      ...
      {/* End Mobile Nav  */}
      <Wrapper
        heading={`Property View: ${entityId}`}
        {...(totalListings > 0 && { listings: convertedListings })}
        total={totalListings}
      />
    </div>
    //  </Suspense>
